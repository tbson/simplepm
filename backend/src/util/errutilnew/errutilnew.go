...
func (e *CustomError) Update(field string, errMsg ErrMsg) *CustomError {
...
func New(field string, msgCode *i18n.Message, args ctype.Dict) *CustomError {
	err := &CustomError{}
	if msgCode == nil {
...
func NewSimpleWithArgs(msgCode *i18n.Message, args ctype.Dict) *CustomError {
	return New(DEFAULT_FIELD, msgCode, args)
}
